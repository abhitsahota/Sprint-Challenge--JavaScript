...
console.log(dinosaurT.weight);

// What was the diet of a velociraptor?
console.log(dinosaurV.diet);

// How long was a stegosaurus?
console.log(dinosaurS.length);

// What time period did tyrannosaurus live in?
console.log(dinosaurT.period);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(dinosaurT.roar);
...
let universities = graduates.map((item) => {
...
zooAnimals.forEach((item) => {
   displayNames.push(`${item.animal_name}, Scientific: ${item.scientific_name}`)
});
